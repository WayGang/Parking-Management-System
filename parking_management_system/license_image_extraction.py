...
class extraction():
    ...
    def store_license_plate(image_path, save_path):
        ...
        plate_dimensions = (
            0.04 * label_image.shape[0], 0.2 * label_image.shape[0], 0.1 * label_image.shape[1],
        ...
        for each_candidate in plate_like_objects:
            ...
            character_dimensions = (
                0.1 * each_candidate.shape[0], 0.9 * each_candidate.shape[0], 0.02 * each_candidate.shape[1],
                0.2 * each_candidate.shape[1])
        ...
        #print('store_license_plate works')
